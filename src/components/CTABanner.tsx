...
const CTABanner = () => (
  <section className="py-20 lg:py-28 bg-slate-800/95 relative overflow-hidden border-t border-slate-700/40">
    ...
    <div className="container mx-auto px-4 relative z-10">
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Button asChild size="lg" variant="outline" className="border-surface-dark-foreground/30 text-surface-dark-foreground bg-transparent hover:bg-accent hover:text-accent-foreground gap-2 text-base px-8">
            <a href="#iletisim">
